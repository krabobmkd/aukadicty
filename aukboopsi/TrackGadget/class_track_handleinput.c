        ...
        case 0x4c: // UP
          {
            ...
            Track_Notify(C,Gad,(APTR)Input, 0);
          }
          break;
...
//          DKP("  c=%ld r=%ld\n", c, r);
          ...
          if(c<gdata->Cols && r<gdata->Rows)
          {
            ...
            if(gdata->ActivePen!=gdata->LastActivePen)
            {
              ...
              Track_Notify(C,Gad,(APTR)Input, OPUF_INTERIM);
              gad_Render(C,Gad,(APTR)Input,GREDRAW_UPDATE);
            }
          }
...
//              retval = GMR_NOREUSE;
    ...
    bdbprintf("SELECTDOWN: %d %d\n",(int)(Input->gpi_Mouse).X,(int)(Input->gpi_Mouse).Y);
            ...
            {// outside gadget or disabled.
              ...
              {
                gdata->_EditMode=0;
                Track_Render(C,Gad,(APTR)Input,GREDRAW_UPDATE);
              }
       ...
       /*   case MENUDOWN:
          if(gdata->EditMode)//                                                                      (44.3.1) (09/01/00)
            {//                                                                                        (44.3.1) (09/01/00)
              ...
              Track_Notify(C,Gad,(APTR)Input, 0);//                                                        (44.3.1) (09/01/00)
            }//                                                                                        (44.3.1) (09/01/00)
            retval = GMR_REUSE;*/
...
/*
    ...
    // if(notifCoords)
    // {
    //     Track_NotifyCoords(C,Gad,Input->gpi_GInfo);
    // }
