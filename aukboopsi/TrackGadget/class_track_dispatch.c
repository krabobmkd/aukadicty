...
//        }
    ...
    case OM_SET:
      ...
      Track_SetAttrs(C,Gad,(struct opSet *)M);
     break;

    case OM_GET:
      Track_GetAttr(C,Gad,(struct opGet *)M);
     break;
...
//      retval=GMR_MEACTIVE;
    ...
    case GM_LAYOUT:
      retval= Track_Layout(C,Gad,(struct gpLayout *)M);
      break;

    case GM_RENDER:
      retval=Track_Render(C,Gad,(struct gpRender *)M,0);
      break;
