...
//        }
    ...
    case OM_SET:
      ...
      TrackHeaderList_SetAttrs(C,Gad,(struct opSet *)M);
     break;

    case OM_GET:
      TrackHeaderList_GetAttr(C,Gad,(struct opGet *)M);
     break;
    ...
    case GM_GOACTIVE:
      ...
      retval=TrackHeaderList_HandleInput(C,Gad,(struct gpInput *)M);
...
//      retval=GMR_MEACTIVE;
    ...
    case GM_GOINACTIVE:
      Gad->Flags &= ~GFLG_SELECTED;
      TrackHeaderList_Render(C,Gad,(APTR)M,GREDRAW_UPDATE);
      break;

    case GM_LAYOUT:
      retval= TrackHeaderList_Layout(C,Gad,(struct gpLayout *)M);
      break;

    case GM_RENDER:
      retval=TrackHeaderList_Render(C,Gad,(struct gpRender *)M,0);
      break;
    ...
    case GM_DOMAIN:
      TrackHeaderList_Domain(C, Gad, (APTR)M);
      retval=1;
